...
const StoreSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'transactionList': PropertySchema(
      id: 1,
      name: r'transactionList',
...
Store _storeDeserialize(
  ...
  final object = Store(
    ...
    transactionList: reader.readObjectList<Transaction>(
          offsets[1],
...
extension StoreQueryFilter on QueryBuilder<Store, Store, QFilterCondition> {
  ...
  QueryBuilder<Store, Store, QAfterFilterCondition>
      transactionListLengthEqualTo(int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Store, Store, QAfterFilterCondition> transactionListIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'transactionList',
        0,
  ...
  QueryBuilder<Store, Store, QAfterFilterCondition>
      transactionListLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
...
extension StoreQueryObject on QueryBuilder<Store, Store, QFilterCondition> {
  QueryBuilder<Store, Store, QAfterFilterCondition> transactionListElement(
      FilterQuery<Transaction> q) {
    return QueryBuilder.apply(this, (query) {
      return query.object(q, r'transactionList');
    });
  }
}
...
extension StoreQueryProperty on QueryBuilder<Store, Store, QQueryProperty> {
  ...
  QueryBuilder<Store, List<Transaction>, QQueryOperations>
      transactionListProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'transactionList');
    });
  }
}
